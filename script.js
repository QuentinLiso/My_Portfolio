...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const fastifyLogo = document.getElementById("fastify-logo");
  const fastiySrc = {
    black: "./assets/fastify_logo.svg",
    white: "./assets/fastify_white_logo.svg",
  };
  ...
  if (savedTheme === "dark" || (!savedTheme && prefersDark)) {
    ...
    fastifyLogo.setAttribute("src", fastiySrc.white);
  }
  ...
  themeToggle.addEventListener("click", function () {
    ...
    if (html.classList.contains("dark")) {
      ...
      fastifyLogo.setAttribute("src", fastiySrc.black);
    }
  });
